...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-10 px-6">
    ...
    <div class="text-center mb-10">
        ...
        <p class="text-gray-600 mt-2 text-sm">Update professor details.</p>
    </div>
    ...
    <div class="bg-white text-gray-800 px-6 lg:px-10 py-10 rounded-2xl shadow-sm">
        <form action="{{ route('admin.professors.update', $professor->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="position" value="{{ old('position', $professor->position) }}" required
                       class="w-full border border-gray-300 px-4 py-3 rounded-xl 
                              focus:outline-none focus:ring-2 focus:ring-[#3c5e5e] transition">
            </div>
            ...
            <div>
                ...
                <input type="text" name="subject" value="{{ old('subject', $professor->subject) }}" required
                       class="w-full border border-gray-300 px-4 py-3 rounded-xl 
                              focus:outline-none focus:ring-2 focus:ring-[#3c5e5e] transition">
            </div>
